...
1. How the NN crowd model was trained from 5 demo videos
...
3. Sliding windows are created for supervised learning
4. MLP neural network is trained and validated
5. Model and reports are saved in models folder
...
## 4) Per-Video Training Summary (5 Demo Videos)
...
- [models/demo5_model_evaluation.json](models/demo5_model_evaluation.json)
